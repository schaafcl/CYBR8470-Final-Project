...
const AboutPage = () => {
  return (
    <div>
      <h2>About Me</h2>
      <p>This application was developed by Chris Schaaf, for the purposes of CYBR8470 Secure Web App Development's final project</p>
      
      <p>This application works as a recipe book to store recipes and allow users to search for recipes by a variety of criteria.  It was meant to address a certain cabinet problem that I imgaine others also experience.  I
